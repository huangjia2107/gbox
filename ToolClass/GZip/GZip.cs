...
namespace ToolClass.GZip
{
    ...
    public class GZip
    {
        ...
        /// Compress
        /// </summary>
        /// <param name="lpSourceFolder">要压缩的目标目录，包括子文件夹</param>
        /// <param name="lpDestFolder">保存压缩文件的目录</param>
        ...
        /// </summary>
        /// <param name="lpSourceFolder">要压缩的目标目录，包括子文件夹</param>
        /// <param name="searchPattern">搜索匹配 (ie "*.*" or "*.txt" or "*.gif") 哪些文件被压缩</param>
        /// <param name="searchOption">只有目标目录中的文件或者包括子文件夹中的文件在内</param>
        /// <param name="lpDestFolder">保存压缩文件的目录</param>
        /// <param name="zipFileName">压缩文件名</param>
        /// <param name="deleteTempFile">Boolean, true 删除临时文件, false 在 lpDestFolder 中保留临时文件(用于调试)</param>
        ...
        /// Compress
        /// </summary>
        /// <param name="files">FileInfo 对象序列将被包含在压缩文件中</param>
        /// <param name="lpBaseFolder">
        ///     当创建相对路径用于存储压缩文件的时候，所用到的基文件夹. 例如： 如果 lpBaseFolder 是 'C:\zipTest\Files\', 在 'files' 序列中
        ///  并有个文件'C:\zipTest\Files\folder1\sample.txt' , 对于 sample.txt 的相对路径就是 'folder1/sample.txt'
        /// </param>
        /// <param name="lpDestFolder">保存压缩文件的目录</param>
        /// <param name="zipFileName">压缩文件名</param>
