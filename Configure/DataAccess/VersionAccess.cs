...
namespace Configure.DataAccess
{
                ...
                XDocument xDoc = new XDocument(
                    ...
                    new XElement("Versions",
                        new XElement("Version",
                            new XComment("更新日期"),
                            new XElement("UpdateTime", Configure.Properties.Resources.UpdateTime),
                            new XComment("当前版本"),
                            new XElement("AppVs", Configure.Properties.Resources.AppVs)
                                                    )));
